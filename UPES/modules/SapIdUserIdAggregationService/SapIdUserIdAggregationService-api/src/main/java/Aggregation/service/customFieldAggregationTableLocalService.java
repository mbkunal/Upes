...
/**
 * Provides the local service interface for customFieldAggregationTable. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see customFieldAggregationTableLocalServiceUtil
...
public interface customFieldAggregationTableLocalService
	extends BaseLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link customFieldAggregationTableLocalServiceUtil} to access the custom field aggregation table local service. Add custom service methods to {@link Aggregation.service.impl.customFieldAggregationTableLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
