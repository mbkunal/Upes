...
/**
 * Provides the local service interface for JobId. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see JobIdLocalServiceUtil
...
public interface JobIdLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link JobIdLocalServiceUtil} to access the job ID local service. Add custom service methods to {@link JobListService.service.impl.JobIdLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
